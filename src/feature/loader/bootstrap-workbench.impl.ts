...
export const featureInitStage = /*#__PURE__*/ new WorkStage('feature init', {
  after: featureSetupStage,
});

export const componentDefStage = /*#__PURE__*/ new WorkStage('component definition', {
  after: featureInitStage,
});
