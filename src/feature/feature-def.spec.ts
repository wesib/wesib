  ...
  describe('FeatureDef', () => {
    describe('of', () => {
      ...
      it('merges with inherited definition', () => {
        ...
        expect(FeatureDef.of(B)).toEqual(
          FeatureDef.merge(A[FeatureDef__symbol], B[FeatureDef__symbol]),
        );
      });
      it('merges with super-inherited definition', () => {
        ...
        expect(FeatureDef.of(C)).toEqual(
          FeatureDef.merge(A[FeatureDef__symbol], C[FeatureDef__symbol]),
        );
      });
    });
